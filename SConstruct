## g++ -Wall -o example ex_bitmap.cpp $(pkg-config --libs allegro-5 allegro_image-5)
## SConstruct
...
buildEnv.ParseConfig('pkg-config allegro-5 --cflags --libs')
projectConfig = {}
################################################################################
...
projectConfig['libraries'] = Split("""
                   allegro_image allegro_ttf allegro_audio allegro_font
	""") + buildEnv['LIBS']
################################################################################
